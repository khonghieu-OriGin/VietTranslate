...
TRANSLATIONS = {
    'vi': {
        ...
        'auth': {
            ...
            'role_hirer': 'Người Thuê Phiên Dịch',
            'role_hirer_desc': 'Tìm và thuê phiên dịch',
            'role_translator': 'Phiên Dịch Viên',
            'role_translator_desc': 'Nhận dự án & làm việc',
            'role_required': 'Vui lòng chọn vai trò của bạn.',
            'role_client_full': 'Tôi là người thuê phiên dịch',
            'role_interpreter_full': 'Tôi là người phiên dịch',
            ...
            'select_role_title': 'Chọn vai trò | VietTranslate',
            'select_role_headline': 'Bạn sử dụng VietTranslate với vai trò nào?',
            'welcome_google': 'Xin chào',
            'continue_btn': 'Tiếp tục',
            'forgot_password_title': 'Quên mật khẩu | VietTranslate',
            'forgot_password_headline': 'Quên mật khẩu?',
            'forgot_password_desc': 'Nhập email đã đăng ký để nhận hướng dẫn đặt lại mật khẩu.',
            'send_reset_email': 'Gửi email đặt lại',
            'sending': 'Đang gửi...',
            'back_to_login': '← Quay lại đăng nhập',
            'reset_password_title': 'Đặt lại mật khẩu | VietTranslate',
            'reset_password_headline': 'Đặt lại mật khẩu',
        ...
        # ─── Dashboard ───
        'dashboard': {
            'client_title': 'Dashboard | VietTranslate',
            'interpreter_title': 'Dashboard | VietTranslate',
            'welcome': 'Xin chào',
            'client_sub': 'Quản lý dự án và tìm phiên dịch viên phù hợp.',
            'interpreter_sub': 'Quản lý công việc và tìm dự án mới.',
            'post_job': 'Đăng việc mới',
            'browse_jobs': 'Tìm việc',
            'my_jobs': 'Việc làm của tôi',
            'my_proposals': 'Báo giá của tôi',
            'my_contracts': 'Hợp đồng gần đây',
            'view_all': 'Xem tất cả',
            'no_jobs_yet': 'Chưa có việc làm nào.',
            'no_proposals_yet': 'Chưa có báo giá nào.',
            'no_contracts_yet': 'Chưa có hợp đồng nào.',
            'find_translator': 'Tìm phiên dịch',
            'edit_profile': 'Hồ sơ',
            'messages': 'Tin nhắn',
            'account': 'Tài khoản',
            'contract_history': 'Lịch sử',
        },
    ...
    'en': {
        ...
        'auth': {
            ...
            'role_hirer': 'Client',
            'role_hirer_desc': 'Find & hire interpreters',
            'role_translator': 'Interpreter',
            'role_translator_desc': 'Find projects & work',
            'role_required': 'Please select your role.',
            'role_client_full': 'I need interpreting services',
            'role_interpreter_full': 'I am an interpreter',
            'fullname_label': 'Full Name',
            'fullname_placeholder': 'e.g., Alex Johnson',
            'phone_label': 'Phone Number',
            'phone_placeholder': '+84 901 234 567',
            'phone_invalid': 'Invalid Vietnamese phone number format.',
            'work_email_label': 'Email',
            'work_email_placeholder': 'name@company.com',
            ...
            'login_link': 'Sign in',
            'select_role_title': 'Select Role | VietTranslate',
            'select_role_headline': 'How will you use VietTranslate?',
            'welcome_google': 'Welcome',
            'continue_btn': 'Continue',
            'forgot_password_title': 'Forgot Password | VietTranslate',
            'forgot_password_headline': 'Forgot your password?',
            'forgot_password_desc': 'Enter your registered email to receive password reset instructions.',
            'send_reset_email': 'Send reset email',
            'sending': 'Sending...',
            'back_to_login': '← Back to sign in',
            'reset_password_title': 'Reset Password | VietTranslate',
            'reset_password_headline': 'Reset Password',
        ...
        'dashboard': {
            ...
            'interpreter_title': 'Dashboard | VietTranslate',
            'welcome': 'Welcome',
            'client_sub': 'Manage your projects and find the right interpreter.',
            'interpreter_sub': 'Manage your work and find new projects.',
            'post_job': 'Post a Job',
            'browse_jobs': 'Browse Jobs',
            'my_jobs': 'My Jobs',
            'my_proposals': 'My Proposals',
            'my_contracts': 'Recent Contracts',
            'view_all': 'View All',
            'no_jobs_yet': 'No jobs posted yet.',
            'no_proposals_yet': 'No proposals yet.',
            'no_contracts_yet': 'No contracts yet.',
            'find_translator': 'Find Interpreter',
